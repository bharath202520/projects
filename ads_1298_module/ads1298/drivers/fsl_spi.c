...
//    config->polarity                  = kSPI_ClockPolarityActiveHigh;// value 0
//    config->polarity                  = kSPI_ClockPolarityActiveLow;// value 1
////    config->phase                     = kSPI_ClockPhaseFirstEdge;//value 0
//    config->phase                     = kSPI_ClockPhaseSecondEdge;//value1
